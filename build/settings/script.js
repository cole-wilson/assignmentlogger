...
$("#submit").click(function(){
	...
	$.get("https://api.assignmentlogger.com/users?mode=new&id="+user.id+"&school="+$("#schoolselect").val()+"&schoology="+$("#schoology").val()+"&p1="+encodeURI($("#p1").val())+"&p2="+encodeURI($("#p2").val())+"&p3="+encodeURI($("#p3").val())+"&p4="+encodeURI($("#p4").val())+"&p5="+encodeURI($("#p5").val())+"&p6="+encodeURI($("#p6").val()),function(data,status){
		window.location = "/";
	})
});